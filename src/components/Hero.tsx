...
export function Hero() {
  return (
    <section className="section pt-24 sm:pt-28 md:pt-32 pb-12 sm:pb-16 md:pb-20 relative overflow-hidden bg-gradient-to-br from-[#FAF4EE] via-[#FAF4EE] to-[#F5E1C8]/30" id="hero" aria-label="Hero">
      <Header />
