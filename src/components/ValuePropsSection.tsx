        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {valueProps.map((vp, i) => (
            <Reveal key={vp.id} delay={i * 0.05}>
              <div className="p-5 rounded-lg border border-black/10 dark:border-white/15 bg-background/60 backdrop-blur supports-[backdrop-filter]:bg-background/40 flex flex-col gap-3 h-full">
